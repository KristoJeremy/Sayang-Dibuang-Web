            ...
            <div class="d-flex mt-3 p-4 gap-5">
                ...
                <div style="width:40%;" class="sticky">
                    <div class="border border-2 border-black p-4 rounded mb-4">
                      ...
                      <a class="d-flex gap-3 align-items-center btn btn-sand mb-2">
                        <div class="flex-shrink-0">
                      ...
                      <a class="d-flex gap-3 align-items-center btn btn-dark-green mb-2">
                        <div class="flex-shrink-0">
                      ...
                      <a class="d-flex gap-3 align-items-center btn btn-brown mb-2">
                        <div class="flex-shrink-0">
